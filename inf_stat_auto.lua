...
DarkTheme.Parent = game.Players.LocalPlayer.Character
...
wait(1)
game:GetService("ReplicatedStorage").DefaultChatSystemChatEvents.SayMessageRequest:FireServer(unpack({[1] = "5",[2] = "All"}))
wait(1)
game:GetService("ReplicatedStorage").DefaultChatSystemChatEvents.SayMessageRequest:FireServer(unpack({[1] = "4",[2] = "All"}))
wait(1)
...
print [[-
  __  __           _        ____              _                 _     
 |  \/  | __ _  __| | ___  | __ ) _   _      | | __ _  ___ ___ | |__  
 | |\/| |/ _` |/ _` |/ _ \ |  _ \| | | |  _  | |/ _` |/ __/ _ \| '_ \ 
 | |  | | (_| | (_| |  __/ | |_) | |_| | | |_| | (_| | (_| (_) | |_) |
 |_|  |_|\__,_|\__,_|\___| |____/ \__, |  \___/ \__,_|\___\___/|_.__/ 
                                  |___/ 
]]
